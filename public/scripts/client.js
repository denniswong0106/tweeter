...
$(document).ready(function() {
  ...
  const data = [
    {
      ...
      "content": {
        "text": "If I have seen further it is by standing on the shoulders of giantsasdfffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
      },
  ...
  const createTweetElement = function (tweetObj) {
    ...
    const tweetHeader = `<header><span>${tweetObj.user.name}</span><span id="handle" >${tweetObj.user.handle}</span></header>`;
